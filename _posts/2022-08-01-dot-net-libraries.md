...
{% raw %} Click if you <BUTTON id="buttonLike" TYPE="button" ONCLICK="var http = new XMLHttpRequest();http.open('GET', 'https://script.google.com/macros/s/AKfycbzZHMD7Y8gp04hSipbZqj0K8ThiV7fxHf0jZboXcfvU1saESYdk5PjyN6XNwMMCj8uv/exec',/*async*/true);http.send(null);http.abort();document.getElementById('countPlus').innerHTML='+1';document.getElementById("buttonLike").disabled=true;alert('Like saved!');">**LIKE**</BUTTON> the text. {% endraw %}
{% raw %} <iframe style="display:inline" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRylKpaTqDluVsX1bgonHR74mApXbnrr7bCr6_z-UaH4fDlD3i6v51tITUbCbbRHl-MfvdS9VNUtDQU/pubhtml?gid=0&amp;single=true&amp;range=A1:B1&amp;widget=false&amp;headers=false&amp;chrome=false" width="143" height="30" frameborder="no" border="0" marginwidth="0" marginheight="0"></iframe> <b id="countPlus">_</b> {% endraw %}
