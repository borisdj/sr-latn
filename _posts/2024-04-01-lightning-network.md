...
Zatim ima opcija za čvorove sa federacijom kao što je [**FediMint**](https://fedimint.org/){:target="_blank"} koji koriste federalne modele za upravljanje. Takođe postoje [BitSNARK & Grail](https://sovryn.com/bitcoinos){:target="_blank"} (Bitcoin [Rollups](https://decrypt.co/228630/bitcoin-rollups-bitcoinos-whitepaper-10x-transaction-speed){:target="_blank"}), kao i [Stacks](https://www.stacks.co/){:target="_blank"}.  
-- U međuvremenu postoji zanimljiv slučaj upotrebe za 'stabilne Sats' (alternativa Stable koinima), poput dolara preko Bitcoin mreže, npr. za ino doznake. Posebno korisno na globalnom jugu gdje su mnoge lokalne valute prilično nestabilne sa veoma visokom inflacijom. Pošto je [*Mutiny*](https://blog.mutinywallet.com/mutiny-wallet-is-shutting-down/){:target="_blank"} novčanik otkazan još jedan sa ovom funkcijom je [10101](https://10101.finance/){:target="_blank"} (10-10-1) finansije. Takođe postoji [Aqua](https://aquawallet.io/){:target="_blank"} novčanik with [Liquid Mrežom](https://liquid.net/){:target="_blank"} (bočni lanac federacije).
