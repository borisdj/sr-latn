...
-- U međuvremenu postoji zanimljiv slučaj upotrebe za 'stabilne Sats' (alternativa Stable koinima), poput dolara preko Bitcoin mreže, npr. za ino doznake. Posebno korisno na globalnom jugu gdje su mnoge lokalne valute prilično nestabilne sa veoma visokom inflacijom. Pošto je *Mutiny* novčanik otkazan još jedan sa ovom funkcijom je [10101](https://10101.finance/){:target="_blank"} (10-10-1) finansije.  
Takođe postoji [Aqua](https://aquawallet.io/){:target="_blank"} novčanik with [Liquid Mrežom](https://liquid.net/){:target="_blank"} (bočni lanac federacije).
